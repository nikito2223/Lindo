    ...
    namespace Components {
        namespace Physics {
            ...
            glm::vec3 BoxCollider::GetWorldCenter() const {
                return Collider::GetWorldPosition(); // ���������� offset �� �������� ������
            }
            ...
            bool BoxCollider::CheckCollision(const MeshCollider* other, CollisionInfo& outInfo) const {
                if (!other) return false;
            ...
            void BoxCollider::OnDrawGizmos() {
                ...
                // 2. Матрица трансформации бокса с офсетом и сайзом
                glm::mat4 transform = glm::translate(world, offset);
                transform = glm::scale(transform, GetSize());

                // 3. Вызов отрисовки WireBox
                debugDraw.DrawWireBox(transform, glm::vec3(0.0f, 1.0f, 1.0f));
