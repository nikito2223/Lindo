...
FirstPersonCamera::FirstPersonCamera(const Transform& playerTransform)
...
FirstPersonCamera::FirstPersonCamera(const glm::vec3& startPosition)
...
void FirstPersonCamera::processKeyboardInput(int key, int action, float deltaTime) {
...
void FirstPersonCamera::updateBob(float deltaTime) {
...
void FirstPersonCamera::setPlayerTransform(Transform& transform) {
...
void FirstPersonCamera::setPosition(const glm::vec3& newPosition) {
