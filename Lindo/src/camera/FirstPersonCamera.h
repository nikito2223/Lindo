...
public:
    // Конструкторы
    FirstPersonCamera(const Transform& playerTransform);
    FirstPersonCamera(const glm::vec3& startPosition = glm::vec3(0.0f, 0.0f, 3.0f));
    ...
    bool invertY = false;
    float heightOffset = 1.7f; // Высота глаз от земли (стандарт)
